...
class MCPClient:
    ...
    def __init__(self):
        ...
        # Get current environment variables to pass to MCP servers
        ...
        self.server_configs = {
            "image-understanding-server": {
                ...
                "transport": "stdio",
                "env": env_vars,  # Pass environment variables to subprocess
            },
            "image-generation-server": {
                "command": "python",
                "args": ["tools/mcp_servers/image_generation.py"],
                "transport": "stdio",
                "env": env_vars,
            },
            ...
            "web-search-server": {
                "command": "python",
                "args": ["tools/mcp_servers/web_search.py"],
                "transport": "stdio",
                "env": env_vars,
            },
            "rag-server": {
